...
# include <assert.h>
  ...
  void makeHeader(int pos, char *text);
  void makeTrailer(int pos, char *text);
...
#define yythunkpos yy->__thunkpos
  ...
  {
#line 121 "leg.leg"
                push(makeAction(yy->__begin, yytext)); ;
#line 417 "leg.c"
  }
#undef yythunkpos
#undef yypos
...
#define yythunkpos yy->__thunkpos
  ...
  {
#line 100 "leg.leg"
                                  push(makeError(yy->__begin, pop(), yytext)); ;
#line 627 "leg.c"
  }
#undef yythunkpos
#undef yypos
